...
import { Truck, MessageCircle, Menu } from 'lucide-react';
import { Link } from 'react-router-dom';

const Navbar: React.FC = () => {
  // আপনার অফিশিয়াল হোয়াটসঅ্যাপ নাম্বার এখানে দিন
  ...
  return (
    <nav className="sticky top-0 z-50 flex justify-between items-center px-6 md:px-[8%] py-4 bg-[#0F172A]/80 backdrop-blur-2xl border-b border-white/5">
      ...
      {/* লোগো ও হোয়াটসঅ্যাপ (Left Side Group) */}
      <div className="flex items-center gap-6">
        ...
        {/* Official WhatsApp - Desktop Only */}
        <a 
          href={whatsappLink}
          target="_blank"
      ...
      <div className="hidden md:flex items-center gap-8 text-[11px] font-bold uppercase tracking-widest text-white/60">
        ...
        <Link 
          to="/login" 
          className="bg-white text-black hover:bg-indigo-500 hover:text-white px-6 py-2.5 rounded-xl font-black transition shadow-xl no-underline"
        >
          Login
        </Link>
      </div>
